...
Describe "FitNesseConfigure-FindFitSharp" {
...
Describe "FitNesseConfigure-MainHelper" {
    ...
    It "should find FitSharp, and create new rules if not existing" {
        ...
        $script:variable | Should -Be ("FitNesse.StartCommand = java -jar c:\a\b.jar -d $($script:basePath) -e 0 -o;FitNesse.WorkFolder = $($script:basePath);")
